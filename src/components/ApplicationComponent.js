...
function Application(props) {
    ...
    <Row className="application">
        ...
        be available for people that need housing for school, travel, or more. But with LiDARTours, life will be able to go on. Our goal  
        is to create robust 3D scale models VR experience that will allow people to view where they may be heading next.
        </h2> </Col>
    </Row>
    <Row className="application">
