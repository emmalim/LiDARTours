...
function Process(props) {
    return (
        <Container>
            ...
            <Row className="application">
                <Col sm="4" md="4">
                    <img width="100%" src={process.env.PUBLIC_URL + '/assets/scanning2.png'} />
                </Col>
                <Col sm="8" md="8" className="whitetext">
                    
                        <h3>Phase 1: Scanning + Sketchfab</h3>
                        <p>
            ...
            <Row className="application">
                <Col sm="4" md="4">
                    <img left width="100%" src={process.env.PUBLIC_URL + '/assets/testing.png'} />
                </Col>
                    <Col sm="8" md="8" className="whitetext">
                        <h3>Phase 2: Upload to Blender and issues implementing in VR</h3>
                            <p>
                            ...
                            our project with that rather than Unity and SteamVR. Unfortunately, this meant 
                            that we weren’t able to include some extra functionality, such as pop-up texts 
            ...
            <Row className="application">
                <Col sm="4" md="4">
                    <img width="100%" src={process.env.PUBLIC_URL + '/assets/smoothing.png'} />
                </Col>
                <Col sm="8" md="8" className="whitetext">
                    <h3>Phase 3: Cleaning up in Blender</h3>
                    <p>
